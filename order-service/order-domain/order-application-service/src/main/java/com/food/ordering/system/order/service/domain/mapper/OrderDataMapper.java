...
public class OrderDataMapper {
    ...
    public OrderApprovalEventPayload orderPaidEventToOrderApprovalEventPayload(OrderPaidEvent orderPaidEvent) {
        return OrderApprovalEventPayload.builder()
                ...
                .products(orderPaidEvent.getOrder().getItems().stream().map(orderItem -> OrderApprovalEventProduct
                                .builder()
    ...
    public OrderPaymentEventPayload orderCanceledEventToOrderPaymentEventPayload(OrderCanceledEvent orderCanceledEvent) {
        return OrderPaymentEventPayload.builder()
